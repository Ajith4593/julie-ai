...
def process_command(command):
    ...
    if 'time' in cmd:
        ...
        st.info(f"☁️ Simulating browser open: https://www.google.com/search?q=weather {location}")
...
with col2:
    ...
    if st.button("🎙️ ACTIVATE VOICE", key="mic_btn", help="Toggle Neural Interface"):
